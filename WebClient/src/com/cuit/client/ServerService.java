 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://webservice.cuit.com/", wsdlLocation = "http://localhost:9001/WebServer/Server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://webservice.cuit.com/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/WebServer/Server?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://webservice.cuit.com/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.cuit.com/", "ServerPort"), Server.class, features);
    }
